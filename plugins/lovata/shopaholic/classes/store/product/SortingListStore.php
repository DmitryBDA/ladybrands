...
class SortingListStore extends AbstractStoreWithParam
{
    ...
    protected function getIDListFromDB() : array
    {
        ...
        }elseif ($this->sValue == ProductListStore::SORT_NAME_ASC) {
            $arElementIDList = $this->getByNameASC();
        }elseif ($this->sValue == ProductListStore::SORT_NAME_DESC) {
            $arElementIDList = $this->getByNameDESC();
        }elseif ($this->sValue == ProductListStore::SORT_QUANTITY) {
            $arElementIDList = $this->getByQuantity();
    ...
    protected function getByNameASC() : array
    {
        $arElementIDList = (array) Product::orderBy('name', 'asc')->lists('id');
        return $arElementIDList;
    }

    protected function getByNameDESC() : array
    {
        $arElementIDList = (array) Product::orderBy('name', 'desc')->lists('id');
        return $arElementIDList;
    }

    protected function getByQuantity() : array
    {
        ...
        $arElementIDList = (array) DB::table('lovata_shopaholic_prices')
            ...
            ->orderBy('lovata_shopaholic_offers.quantity', 'desc')
