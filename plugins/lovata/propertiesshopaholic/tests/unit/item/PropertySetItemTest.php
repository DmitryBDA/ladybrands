...
/**
 * Class PropertySetItemTest
 * @package Lovata\PropertiesShopaholic\Tests\Unit\Item
 * @author Andrey Kharanenka, a.khoronenko@lovata.com, LOVATA Group
 *
 * @mixin \PHPUnit\Framework\Assert
 */
class PropertySetItemTest extends CommonTest
{
    /** @var  PropertySet */
    protected $obElement;
    ...
    public function testItemFields()
    {
        ...
        $sErrorMessage = 'PropertySet item data is not correct';

        $arCreatedData = $this->arCreateData;
        $arCreatedData['id'] = $this->obElement->id;

        //Check item fields
        $obItem = PropertySetItem::make($this->obElement->id);
    ...
    public function testItemClearCache()
    {
        ...
        $sErrorMessage = 'PropertySet item data is not correct, after model update';
    ...
    public function testRemoveElement()
    {
        ...
        $sErrorMessage = 'PropertySet item data is not correct, after model remove';
